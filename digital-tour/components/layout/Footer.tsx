    ...
    <footer className="bg-gradient-to-b from-slate-800 to-slate-900 text-slate-300">
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-6 py-16">
        ...
        <div className="flex flex-col gap-16 lg:grid lg:grid-cols-4 lg:gap-6">
          ...
          <div className="grid grid-cols-2 justify-between gap-y-16 md:col-span-2 md:grid-cols-2 lg:col-span-2 lg:grid-cols-2">
            {/* Explore */}
            <div className="space-y-6 m-auto">
              <h3 className={footerHeader}>Explore</h3>
              <ul className="mt-6 space-y-4">
                <li>
                  <Link href="/" className={footerLink + " text-base"}>
                    Home
                  </Link>
                </li>
                <li>
                  <Link href="/tours" className={footerLink + " text-base"}>
                    Tours
                  </Link>
                </li>
                <li>
                  <Link href="/about" className={footerLink + " text-base"}>
                    About Us
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className={footerLink + " text-base"}>
                    Contact
                  </Link>
                </li>
                <li>
                  <Link href="/faq" className={footerLink + " text-base"}>
                    FAQ
                  </Link>
                </li>
              </ul>
            ...
            <div className="space-y-6">
              ...
              <ul className="mt-6 space-y-4">
                <li>
                  <Link href="/privacy" className={footerLink + " text-base"}>
                    Privacy Policy
                  </Link>
                </li>
                <li>
                  <Link href="/terms" className={footerLink + " text-base"}>
                    Terms of Service
                  </Link>
                </li>
                <li>
                  <Link href="/careers" className={footerLink + " text-base"}>
                    Careers
                  </Link>
                </li>
                <li>
                  <Link href="/support" className={footerLink + " text-base"}>
                    Support
                  </Link>
                </li>
              </ul>
          ...
          <div className="space-y-6 lg:col-span-1">
            ...
            <div className="mt-6 mb-8 flex flex-wrap gap-4">
              {[
                ...
                <a
                  ...
                  className="flex h-12 w-12 items-center justify-center rounded-xl border border-slate-600/60 text-slate-400 transition-all duration-300 hover:border-emerald-400 hover:text-emerald-400 hover:scale-110">
                  {item.icon}
                </a>
              ))}
            </div>
            ...
            <Link
              href="/Signup"
              className="inline-flex items-center justify-center w-full rounded-xl bg-emerald-500 px-6 py-3 text-base font-semibold text-white transition hover:bg-emerald-600 hover:shadow-lg hover:shadow-emerald-500/20">
              Join the Trail
            </Link>
          </div>
        </div>
      ...
      <div className="border-t border-slate-700/60 py-6 text-center text-sm text-slate-400">
        © {new Date().getFullYear()} Forest
        <span className="text-emerald-400">•</span>Trails. All rights reserved.
      </div>
    </footer>
  );
}
