...
const PropertyCard = ({ id, name, location, price, image }: PropertyCardProps) => {
  return (
    <div className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-lg transition transform hover:-translate-y-1">
      ...
      {/* Info */}
      <div className="p-4">
        <h3 className="text-lg sm:text-xl md:text-2xl font-semibold mb-1 text-slate-900">{name}</h3>
